...
ptim=prefilterlowpass2d(tim,W2);    %filter the original image
figure
subplot(2,2,1);
imshow( tim, [0 1]);
...
%PSNR mit prefilter
prtim=prefilterlowpass2d(ptim,W2)*4;
...
wtim=upsample(wtim,2);
wtim=permute(wtim,[2,1,3]);
wrtim=prefilterlowpass2d(wtim,W2)*4;
